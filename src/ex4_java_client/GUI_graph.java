    ...
    public GUI_graph(DirectedWeightedGraphAlgorithms AlgoGraph) {
        ...
        this.getRootPane().addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e) {
                ...
                WIDTH = GUI_graph.this.getWidth();
                HEIGHT = GUI_graph.this.getHeight();
                //System.out.println(WIDTH+" "+HEIGHT);
                GUI_graph.this.setSize((int) WIDTH,(int) HEIGHT);
                GUI_graph.this.repaint();
                save.setBounds((int) WIDTH - 250, (int) (HEIGHT / 2), 222, 20);
            }
        });
        System.out.println(WIDTH+" "+HEIGHT);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == Paths) {
            try {
                ...
                List<NodeData> l = this.AlgoGraph.shortestPath(Integer.parseInt(id[0]), Integer.parseInt(id[1]),1);
                this.g.external.removeAll(this.g.external);
        ...
        if(e.getSource()==dist)
        {
            try{
                ...
                double dist=this.AlgoGraph.shortestPathDist(Integer.parseInt(s[0]),Integer.parseInt(s[1]),1);
